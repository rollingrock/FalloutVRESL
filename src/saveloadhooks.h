...
{
	static inline int F4SaveVersion = 68;   // skyrim was 78.   fallout looks to be 68
	static inline int VRSaveVersion = 67;   // skyrim was 77.   fallout looks to be 67

	struct SaveVersionHook
	{
		static void InstallGetSaveVersionFuncHook()
		{
			REL::Relocation<std::uintptr_t> target{ REL::Offset(0x0d38150) };  // Skyrim was 0x58F1C0
			REL::safe_fill(target.address(), REL::NOP, 0x7);
			byte newSaveVersion[5] = { 0xB8, 0x44, 0x00, 0x00, 0x00 };  // mov eax, 68
	...
	struct SaveModshook
	{
		static RE::BGSSaveGameBuffer* BGSSaveGameBufferCTOR(RE::BGSSaveGameBuffer* a_buffer)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d53e70) };  // 0x5A0E70
		...
		static void BGSSaveGameBuffer_SaveFileName(RE::BGSSaveGameBuffer* a_buffer, const char* a_fileName)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d540f0) };  // 0x5a1100
		...
		static void BGSSaveGameBufferDTOR(RE::BGSSaveGameBuffer* a_buffer)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d53e90) };  // 0x5A0E90
			return func(a_buffer);
		}
	...
	struct LoadModsHook
	{
		static RE::BGSLoadGameBuffer* BGSLoadGameBufferCTOR(RE::BGSLoadGameBuffer* a_buffer)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d50f60) };  // Skyrim 0x59EF30
			return func(a_buffer);
		}
		...
		static void BGSLoadGameBufferFile(RE::BGSLoadGameBuffer* a_buffer, Win32FileType* a_unk)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d50fd0) };  // Skyrim 0x59EFB0
			return func(a_buffer, a_unk);
		}
		...
		static void BGSLoadGameBufferDTOR(RE::BGSLoadGameBuffer* a_buffer)
		{
			...
			REL::Relocation<func_t> func{ REL::Offset(0x0d50f90) };  // Skyrim 0x59EF60
			return func(a_buffer);
		}
		...
		static bool LoadMods(SaveLoadGame* a_saveloadGame, Win32FileType* a_unk2, std::uint64_t a_unk3)
		{
			...
			buffer->LoadDataEndian(&regularFileCount, 1u, 0);  
			char fileName[328]{ 0 };
			...
			if (buffer->GetVersion() >= F4SaveVersion) {
	...
	{
		static inline REL::Relocation<std::uintptr_t> target{ REL::Offset(0x0d24da0) };  // skyrim 0x581660
